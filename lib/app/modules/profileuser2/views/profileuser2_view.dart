...
import '../../../widgets/skeleton_loading/profileuser2_skeleton.dart';
...
class Profileuser2View extends StatelessWidget {
  ...
  // Method untuk format currency dengan titik koma
      ...
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          body: RefreshIndicator(
            onRefresh: () async {
              await controller.fetchCompanyDetails();
            },
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: cardColor,
                                        borderRadius:
                                            BorderRadius.circular(res.wp(4)),
                                        boxShadow: [
                                          BoxShadow(
                                            color:
                                            ...
                                            child: FutureBuilder<
                                              ...
                                              builder: (context, snapshot) {
                                                if (snapshot.connectionState ==
                                                  ...
                                                  final totalSales = snapshot
                                                          .data!['total_sales']
                                                      as double;
                                                  
                                                  // Format rupiah dengan titik koma
                                                  final formattedSales = _formatCurrency(totalSales);
